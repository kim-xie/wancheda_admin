    ...
    <el-col :span="24">
      <el-menu class="el-menu-vertical" @open="handleOpen" @close="handleClose" :router="router" :unique-opened="openedOne" :default-active="$route.path" >
        ...
        <el-submenu index="3">
          ...
          <el-menu-item-group>
            <el-menu-item index="/client/list">客户维护</el-menu-item>
        ...
        <el-submenu index="4">
          ...
          <el-menu-item-group>
            <el-menu-item index="/product/list">配件维护</el-menu-item>
            <el-menu-item index="/product/manager">库存管理</el-menu-item>
            <el-menu-item index="/product/add">配件入库
              <el-badge class="mark" :value="this.$store.state.inpartCount"/>
            </el-menu-item>
            <el-menu-item index="/product/remove">配件出库
        ...
        <el-submenu index="5">
          ...
          <el-menu-item-group>
            <el-menu-item index="/financial/list">财务统计</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="6">
          <template slot="title"><i class="icon-tasks mr5"></i>数据字典</template>
          <el-menu-item-group>
            <el-menu-item index="/lookup/lookupDF">数据字典定义</el-menu-item>
            <el-menu-item index="/lookup/list">数据字典管理</el-menu-item>
          </el-menu-item-group>
        </el-submenu>
        <el-submenu index="7">
          <template slot="title"><i class="icon-cogs mr5"></i>系统设置</template>
          <el-menu-item-group>
            <el-menu-item index="/account/list">账号管理</el-menu-item>
            <el-menu-item index="/company/list">公司管理</el-menu-item>
